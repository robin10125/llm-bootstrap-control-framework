# Pareto Fixed Prior Shaped Reward 12h 128env

- **Run directory:** [`runs/pareto_fixed_prior_shaped_reward_12h_128env_20260622-193556`](../runs/pareto_fixed_prior_shaped_reward_12h_128env_20260622-193556)
- **Date:** 2026-06-22 19:35:56 (directory timestamp)
...
`lift_s0_baseline`, `pre_run_reward_analysis`
...
- [`config.json`](../runs/pareto_fixed_prior_shaped_reward_12h_128env_20260622-193556/config.json)
- [`metrics.jsonl`](../runs/pareto_fixed_prior_shaped_reward_12h_128env_20260622-193556/metrics.jsonl)
