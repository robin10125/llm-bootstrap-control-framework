...
- **Run directory:** [`runs/arm_adjusted`](../runs/arm_adjusted)
...
| wall_hours | 2.001 |
| iters | 641 |
| best_metric | 0.000317 |
| best_train_success | 0 |
| best_iter | 1 |

| Evaluation metric | Value |
|---|---|
| eval_base_return | 0.0652 |
| eval_base_reward_weight | 1 |
| eval_shaped_return | -0.145509 |
| eval_train_return | -0.080309 |
| eval_success_rate | 0 |
| eval_instant_success_rate | 0 |
| eval_reach_rate | 0.1875 |
| eval_grasp_rate | 0.082031 |
| eval_grasp_lift_rate | 0.007812 |
| eval_lift_reached_rate | 0.21875 |
| eval_lift_max | 0.042339 |
| eval_hard_clip_frac | 0 |
| eval_saturation_frac | 0 |
| eval_action_abs_mean | 0.134327 |
...
|---|---|---|---|---|---|---|---|---|---|
| freeform_encourage | 642 | 641 | 16435200 | 7,202.081 | 0 | 0 | 0.018707 | 9.417316 | — |
...
- The best terminal success measurement was `arm_adjusted` at 0 (eval_success_rate).
...
- [`config.json`](../runs/arm_adjusted/config.json)
- [`final_report.json`](../runs/arm_adjusted/final_report.json)
- [`metrics.jsonl`](../runs/arm_adjusted/metrics.jsonl)
