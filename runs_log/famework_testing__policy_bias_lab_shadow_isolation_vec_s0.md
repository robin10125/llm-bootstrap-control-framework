# Policy Bias Lab Shadow Isolation Vec S0

- **Run directory:** [`famework_testing/runs/policy_bias_lab_shadow_isolation_vec_s0`](../famework_testing/runs/policy_bias_lab_shadow_isolation_vec_s0)
...
- [`config.json`](../famework_testing/runs/policy_bias_lab_shadow_isolation_vec_s0/config.json)
- [`metrics.jsonl`](../famework_testing/runs/policy_bias_lab_shadow_isolation_vec_s0/metrics.jsonl)
