...
- **Run directory:** [`runs/critic_diversity_4h`](../runs/critic_diversity_4h)
- **Date:** 2026-07-13 (earliest surviving artifact mtime (approximate))
...
| task | lift |
| seed | 0 |
| extra_programs | runs/prior_gen_study_20260711/kl_simple/program.json, runs/prior_gen_study_20260711/critic_use/program.json |
| critical_stages | — |
| env.horizon | 800 |
| env.control_dt | 0.025 |
| env.episode_seconds | 20 |
...
| iters | 500 |
| best_iter | 324 |
| best_objective | 1.433577 |
| eval_objective | 0.92737 |
| eval_graded_objective | 0.92737 |
| eval_task_fitness | 1.415648 |
| eval_success_rate | 0.113281 |
...
| eval_task_fitness | 1.415648 |
| eval_reach_rate | 1 |
| eval_grasp_rate | 0.957031 |
| eval_grasp_lift_rate | 0.101562 |
| eval_lift_reached_rate | 0.113281 |
| eval_lift_max | 0.029247 |
| eval_train_return | 127.242 |
| eval_base_return | 127.242 |
| eval_shaping_return | 0 |
| eval_prior_disagreement | 0.300507 |
| eval_graded_objective | 0.92737 |
...
| iters | 500 |
| best_iter | 474 |
| best_objective | 1.873339 |
| eval_objective | 0.828145 |
| eval_graded_objective | 0.828145 |
| eval_task_fitness | 1.886315 |
| eval_success_rate | 0.027344 |
...
| eval_reach_rate | 1 |
| eval_grasp_rate | 1 |
| eval_grasp_lift_rate | 0.027344 |
| eval_lift_reached_rate | 0.027344 |
| eval_lift_max | 0.022659 |
| eval_train_return | 315.877 |
| eval_base_return | 315.877 |
| eval_shaping_return | 0 |
| eval_prior_disagreement | 0.399828 |
| eval_graded_objective | 0.828145 |
...
|---|---|---|---|---|---|---|---|---|---|
| parallel_s0 | 500 | 499 | 12800000 | 7,134.36 | 0.007812 | 0.152344 | — | 26.423447 | 1.433577 |
| union_s0 | 500 | 499 | 12800000 | 7,131.436 | 0 | 0.160156 | — | 25.14847 | 1.873339 |
...
- `parallel_s0.log`: [done] method=critic_features 500 fragments, best_iter=324, graded_objective=0.92737 success=0.113281 -> runs/critic_diversity_4h/parallel_s0
- `union_s0.log`: [done] method=critic_features 500 fragments, best_iter=474, graded_objective=0.828145 success=0.027344 -> runs/critic_diversity_4h/union_s0

## What the results mean and major discoveries

- Across terminal sub-run reports, `union_s0` recorded the strongest eval_task_fitness (1.886315).
- The best terminal success measurement was `parallel_s0` at 0.113281 (eval_success_rate).
...
- [`parallel_s0/config.json`](../runs/critic_diversity_4h/parallel_s0/config.json)
- [`parallel_s0/final_report.json`](../runs/critic_diversity_4h/parallel_s0/final_report.json)
- [`parallel_s0/metrics.jsonl`](../runs/critic_diversity_4h/parallel_s0/metrics.jsonl)
- [`summary.md`](../runs/critic_diversity_4h/summary.md)
- [`union_s0/config.json`](../runs/critic_diversity_4h/union_s0/config.json)
- [`union_s0/final_report.json`](../runs/critic_diversity_4h/union_s0/final_report.json)
- [`union_s0/metrics.jsonl`](../runs/critic_diversity_4h/union_s0/metrics.jsonl)
...
### Source: [`summary.md`](../runs/critic_diversity_4h/summary.md)

## critic-feature diversity study (2 arms x 1 seed x 2h)

union = kl_nouse+kl_simple+critic_use feature union (complexity diversity)
parallel = kl_nouse + parallel gate values (cursor-free)

| run | graded | success | fitness | best_iter/iters |
|---|---:|---:|---:|---:|
| parallel_s0 | 0.92737 | 0.113281 | 1.415648 | 324/500 |
| union_s0 | 0.828145 | 0.027344 | 1.886315 | 474/500 |
