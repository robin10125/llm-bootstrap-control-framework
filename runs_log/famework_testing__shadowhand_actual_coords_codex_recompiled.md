# Shadowhand Actual Coords Codex Recompiled

- **Run directory:** [`famework_testing/runs/shadowhand_actual_coords_codex_recompiled`](../famework_testing/runs/shadowhand_actual_coords_codex_recompiled)
- **Date:** 2026-06-16 (earliest surviving artifact mtime (approximate))
...
| Recorded field | Value |
|---|---|
| source_run | runs/shadowhand_actual_coords_codex/lift_s0_recursive_units_a0 |
| task.name | lift |
...
| Recorded field | Value |
|---|---|
| source_run | runs/shadowhand_actual_coords_codex/lift_s0_recursive_units_a0_repair1 |
| task.name | lift |
| task.goal | raise the object above the table and keep it controlled |
| task.seed | 0 |
| task.episode_seconds | 2.5 |
