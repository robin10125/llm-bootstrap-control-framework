...
Unit command: Relative to the final centered palm pose, move from open g_right=0.06 toward strong flexion/near closed, about g_right=0.005 to 0.015, maintaining inward opposing pressure on the object throughout lift and hold.
Phase schedule: [
  {
    "phase": "approach",
