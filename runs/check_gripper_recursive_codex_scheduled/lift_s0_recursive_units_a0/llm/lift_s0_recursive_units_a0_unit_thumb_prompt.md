...
Unit command: Relative to the final palm/base pose, keep the thumb flexed inward from open to a firm near-closed opposing pinch against the object, maintaining grip during lift.
Phase schedule: [
  {
    "phase": "approach",
