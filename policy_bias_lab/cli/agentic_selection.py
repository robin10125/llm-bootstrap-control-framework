...
docs/agentic_prior_selection.md and agentic_orchestrator.py), writes the winning prior program, and
prints how to hand it to the default PPO runner.

Example:
  python -m policy_bias_lab.cli.agentic_selection --out runs/agentic1 --rep freeform_staged --budget 20
  # then PPO-train the discovered prior:
  python -m policy_bias_lab.cli.prior_ppo --arms freeform_encourage \
...
def main() -> int:
    ...
    ap.add_argument("--rep", choices=["freeform_staged"], default="freeform_staged",
                    help="output representation: free-form prior with model-authored "
    ...
    ap.add_argument("--dashboard", action="store_true",
                    ...
                    "regenerate manually anytime: python -m policy_bias_lab.cli.dashboard <out>).")
    args = ap.parse_args()
